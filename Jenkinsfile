        ...
        stage('Copying Scripts from local dir to jenkins dir') {
            steps {
                echo 'Copying Scripts...'
                 ...
                 powershell returnStatus: true, script: "Copy-Item 'C:/ProgramData/Jenkins/.jenkins/workspace/test/checkJIRAIssues.ps1' -Destination 'C:/ProgramData/Jenkins/.jenkins/workspace/test/CM_Scripts'"
