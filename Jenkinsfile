        ...
        stage('Copying Scripts from local dir to jenkins dir') {
            steps {
                echo 'Copying Scripts...'
                 ...
                 powershell returnStatus: true, script: "Copy-Item -Force -Recurse -Verbose 'C:/Users/USER/Documents/GitHub/Test-jenkins/scripts/*' -Destination '${env.WORKSPACE}/CM_Scripts'"
                 powershell returnStatus: true, script: "Copy-Item -Force -Recurse -Verbose 'C:/Users/USER/Documents/GitHub/Test-jenkins/scripts/*' -Destination '${env.WORKSPACE}/CM_Package'"
