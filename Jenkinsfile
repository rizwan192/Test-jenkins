        ...
        stage('Copying Scripts from local dir to jenkins dir') {
            steps {
                echo 'Copying Scripts...'
                 ...
                 powershell returnStatus: true, script: "Copy-Item 'C:/Users/USER/Documents/GitHub/Test-jenkins/scripts/*' -Destination 'C:/ProgramData/Jenkins/.jenkins/workspace/test/CM_Scripts -Recurse'"
                 powershell returnStatus: true, script: "Copy-Item 'C:/Users/USER/Documents/GitHub/Test-jenkins/scripts/*' -Destination 'C:/ProgramData/Jenkins/.jenkins/workspace/test/CM_Package -Recurse'"
